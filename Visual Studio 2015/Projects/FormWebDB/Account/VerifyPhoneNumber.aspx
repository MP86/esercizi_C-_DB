<%@ Page Title="Verifica numero di telefono" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="FormWebDB.Account.VerifyPhoneNumber" %>
