<%@ Page Title="Registra account di accesso esterno" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="FormWebDB.Account.RegisterExternalLogin" Async="true" %>
